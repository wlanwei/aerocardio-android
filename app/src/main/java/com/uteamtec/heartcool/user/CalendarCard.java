...
import com.uteamtec.heartcool.model.CustomDate;
import com.uteamtec.heartcool.model.DateUtil;
...
public class CalendarCard extends View {
    ...
    private boolean callBackCellSpace; //单击

    private Cell mClickCell; //

    private float mDownX; //横坐标
    private float mDownY; //纵坐标
    ...
    private void init(Context context) {
        ...
        mCirclePaint.setColor(Color.parseColor("#FF85A2")); // 透明圆形
    ...
    protected void onSizeChanged(int w, int h, int oldw, int oldh) {
        ...
        mViewWidth = w;
        mViewHeight = h;
        mCellSpace = Math.min(mViewHeight / TOTAL_ROW, mViewWidth /(TOTAL_COL-1) );
